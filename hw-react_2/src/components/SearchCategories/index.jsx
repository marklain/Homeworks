...
const SearchCategories = ({ getData }) => {
        return (
            <div className="SearchCategories">
                <button
                    onClick={() => getData('https://api.themoviedb.org/3/movie/popular?api_key=f24a0fd18f52218851075901c5a108a0&language=en-US&page=1')} className="SearchCategories__btn">popular</button>
                <button
